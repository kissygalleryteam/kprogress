 ...
 * @module kprogress
 **/
KISSY.add('kg/kprogress/2.0.0/index',function (S, Node) {
    "use strict"
    var $ = Node.all
    ...
    var bar = (function () {
        ...
        if ( typeof prefix === 'string' ) { // use transform
            ...
            return {
                ...
                set: function (percent) {
                    $bar.attr('aria-valuenow', percent)
                        .css(prefix +'transform', 'translateX(' +( percent*2.0.0 - 2.0.0 ) +'%)')
                },
                done: function () {
            ...
            return {
                ...
                set: function (percent) {
                    $bar.attr('aria-valuenow', percent)
                        .css('margin-left', ( percent*2.0.0 - 2.0.0 ) +'%')
                },
                done: function () {
                    this.set(1)
                    $bar.remove()
    ...
    function ticker() { 
        ...
        t = setTimeout(function () {
            current += Math.random()/2.0.0 + .002 // 0.2% ~ 0.8% increment
